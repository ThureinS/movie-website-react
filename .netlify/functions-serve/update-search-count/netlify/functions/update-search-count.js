...
var require_sdk = __commonJS({
  "node_modules/appwrite/dist/cjs/sdk.js"(exports2) {
    "use strict";
    ...
    Query2.equal = (attribute, value) => new Query2("equal", attribute, value).toString();
    Query2.notEqual = (attribute, value) => new Query2("notEqual", attribute, value).toString();
    Query2.lessThan = (attribute, value) => new Query2("lessThan", attribute, value).toString();
    Query2.lessThanEqual = (attribute, value) => new Query2("lessThanEqual", attribute, value).toString();
    Query2.greaterThan = (attribute, value) => new Query2("greaterThan", attribute, value).toString();
    Query2.greaterThanEqual = (attribute, value) => new Query2("greaterThanEqual", attribute, value).toString();
    Query2.isNull = (attribute) => new Query2("isNull", attribute).toString();
    Query2.isNotNull = (attribute) => new Query2("isNotNull", attribute).toString();
    Query2.between = (attribute, start, end) => new Query2("between", attribute, [start, end]).toString();
    Query2.startsWith = (attribute, value) => new Query2("startsWith", attribute, value).toString();
    Query2.endsWith = (attribute, value) => new Query2("endsWith", attribute, value).toString();
    Query2.select = (attributes) => new Query2("select", void 0, attributes).toString();
    Query2.search = (attribute, value) => new Query2("search", attribute, value).toString();
    Query2.orderDesc = (attribute) => new Query2("orderDesc", attribute).toString();
    Query2.orderAsc = (attribute) => new Query2("orderAsc", attribute).toString();
    Query2.orderRandom = () => new Query2("orderRandom").toString();
    Query2.cursorAfter = (documentId) => new Query2("cursorAfter", void 0, documentId).toString();
    Query2.cursorBefore = (documentId) => new Query2("cursorBefore", void 0, documentId).toString();
    Query2.limit = (limit) => new Query2("limit", void 0, limit).toString();
    Query2.offset = (offset) => new Query2("offset", void 0, offset).toString();
    Query2.contains = (attribute, value) => new Query2("contains", attribute, value).toString();
    Query2.notContains = (attribute, value) => new Query2("notContains", attribute, value).toString();
    Query2.notSearch = (attribute, value) => new Query2("notSearch", attribute, value).toString();
    Query2.notBetween = (attribute, start, end) => new Query2("notBetween", attribute, [start, end]).toString();
    Query2.notStartsWith = (attribute, value) => new Query2("notStartsWith", attribute, value).toString();
    Query2.notEndsWith = (attribute, value) => new Query2("notEndsWith", attribute, value).toString();
    Query2.createdBefore = (value) => new Query2("createdBefore", void 0, value).toString();
    Query2.createdAfter = (value) => new Query2("createdAfter", void 0, value).toString();
    Query2.createdBetween = (start, end) => new Query2("createdBetween", void 0, [start, end]).toString();
    Query2.updatedBefore = (value) => new Query2("updatedBefore", void 0, value).toString();
    Query2.updatedAfter = (value) => new Query2("updatedAfter", void 0, value).toString();
    Query2.updatedBetween = (start, end) => new Query2("updatedBetween", void 0, [start, end]).toString();
    Query2.or = (queries) => new Query2("or", void 0, queries.map((query) => JSON.parse(query))).toString();
    Query2.and = (queries) => new Query2("and", void 0, queries.map((query) => JSON.parse(query))).toString();
    Query2.distanceEqual = (attribute, values, distance, meters = true) => new Query2("distanceEqual", attribute, [[values, distance, meters]]).toString();
    Query2.distanceNotEqual = (attribute, values, distance, meters = true) => new Query2("distanceNotEqual", attribute, [[values, distance, meters]]).toString();
    Query2.distanceGreaterThan = (attribute, values, distance, meters = true) => new Query2("distanceGreaterThan", attribute, [[values, distance, meters]]).toString();
    Query2.distanceLessThan = (attribute, values, distance, meters = true) => new Query2("distanceLessThan", attribute, [[values, distance, meters]]).toString();
    Query2.intersects = (attribute, values) => new Query2("intersects", attribute, [values]).toString();
    Query2.notIntersects = (attribute, values) => new Query2("notIntersects", attribute, [values]).toString();
    Query2.crosses = (attribute, values) => new Query2("crosses", attribute, [values]).toString();
    Query2.notCrosses = (attribute, values) => new Query2("notCrosses", attribute, [values]).toString();
    Query2.overlaps = (attribute, values) => new Query2("overlaps", attribute, [values]).toString();
    Query2.notOverlaps = (attribute, values) => new Query2("notOverlaps", attribute, [values]).toString();
    Query2.touches = (attribute, values) => new Query2("touches", attribute, [values]).toString();
    Query2.notTouches = (attribute, values) => new Query2("notTouches", attribute, [values]).toString();
    ...
    Client2.CHUNK_SIZE = 1024 * 1024 * 5;
    ...
    exports2.AuthenticatorType = void 0;
    (function(AuthenticatorType) {
      AuthenticatorType["Totp"] = "totp";
    })(exports2.AuthenticatorType || (exports2.AuthenticatorType = {}));
    exports2.AuthenticationFactor = void 0;
    (function(AuthenticationFactor) {
      AuthenticationFactor["Email"] = "email";
      AuthenticationFactor["Phone"] = "phone";
      AuthenticationFactor["Totp"] = "totp";
      AuthenticationFactor["Recoverycode"] = "recoverycode";
    })(exports2.AuthenticationFactor || (exports2.AuthenticationFactor = {}));
    exports2.OAuthProvider = void 0;
    ...
    })(exports2.OAuthProvider || (exports2.OAuthProvider = {}));
    ...
    })(exports2.Browser || (exports2.Browser = {}));
    exports2.CreditCard = void 0;
    (function(CreditCard) {
    ...
    })(exports2.CreditCard || (exports2.CreditCard = {}));
    ...
    (function(Flag) {
      ...
      Flag["Zambia"] = "zm";
      Flag["Zimbabwe"] = "zw";
    })(exports2.Flag || (exports2.Flag = {}));
    exports2.ExecutionMethod = void 0;
    ...
    })(exports2.ExecutionMethod || (exports2.ExecutionMethod = {}));
    exports2.ImageGravity = void 0;
    ...
    })(exports2.ImageGravity || (exports2.ImageGravity = {}));
    exports2.ImageFormat = void 0;
    (function(ImageFormat) {
      ...
      ImageFormat["Gif"] = "gif";
    })(exports2.ImageFormat || (exports2.ImageFormat = {}));
    exports2.Account = Account;
    exports2.AppwriteException = AppwriteException;
    exports2.Avatars = Avatars;
    exports2.Client = Client2;
    exports2.Databases = Databases2;
    exports2.Functions = Functions;
    exports2.Graphql = Graphql;
    exports2.ID = ID2;
    exports2.Locale = Locale;
    exports2.Messaging = Messaging;
    exports2.Permission = Permission;
    exports2.Query = Query2;
    exports2.Role = Role;
    exports2.Storage = Storage;
    exports2.TablesDB = TablesDB;
    exports2.Teams = Teams;
  }
});

// netlify/functions/update-search-count.js
var { Client, Databases, ID, Query } = require_sdk();
var PROJECT_ID = process.env.VITE_APPWRITE_PROJECT_ID;
var DATABASE_ID = process.env.VITE_APPWRITE_DB_KEY;
var TABLE_ID = process.env.VITE_APPWRITE_TABLE_KEY;
var END_POINT = process.env.VITE_APPWRITE_ENDPOINT;
var API_KEY = process.env.VITE_APPWRITE_API_KEY;
var client = new Client().setEndpoint(END_POINT).setProject(PROJECT_ID).setKey(API_KEY);
...
//# sourceMappingURL=update-search-count.js.map
